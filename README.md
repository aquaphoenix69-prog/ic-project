...
- `Yug` - Core Engine & State Management
...
- `Aditya` - Collision System & UI/HUD
...
- `Premansh (Pompu)` should lead asset collection, integration, and polish.
